...
def load_settings() -> RAGSettings:
    ...
    settings = RAGSettings(
        ...
        chat_base_url=_env("RAG_CHAT_BASE_URL", "https://api.deepseek.com/v1"),
        chat_api_key=_env("RAG_CHAT_API_KEY", "*****"),
        chat_model=_env("RAG_CHAT_MODEL", "deepseek-chat"),
        embedding_base_url=_env("RAG_EMBEDDING_BASE_URL", _env("RAG_CHAT_BASE_URL", "***")),
